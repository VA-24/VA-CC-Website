            ...
            <nav class='w-full flex flex-row items-center justify-center tracking-tight gap-8'>
                ...
                <a target='_blank' class='sticky z-[2] top-0 lg:top-32 [&>div>.shine]:hover:block w-full max-w-lg md:max-w-3xl lg:max-w-4xl xl:max-w-6xl h-[90vh] lg:h-[80vh] lg:max-h-[600px] flex flex-col xl:flex-row border border-blue-800 p-2 justify-start gap-8 px-4 py-8 lg:px-6 xl:px-12 xl:py-5 bg-white rounded-xl' data-aos='fade-up'>
                    <div class='flex flex-col gap-4'>
                        ...
                        <p class='text-base xl:text-lg 2xl:text-xl text-neutral-700'>An offer truly like none other on the market (other similar serviecs offered by counselors fall in the range of $3000 - $5000!), take full advantage of my services with this package. Rehash your essays, ask me virtually anything about your college journey, and schedule mock interviews. For any questions, email me at va648314@gmail.com. Payments made through PayPal.</p>
