...
<div className='relative w-full h-[40vh] lg:w-[230px] lg:h-[220px] xl:w-[300px] xl:h-[430px] flex-shrink-0 shadow-lg shadow-neutral-700 overflow-hidden rounded-lg select-none ease-linear transition mt-1 [&>.shine]:hover:block'>
    <img
        src={require('../assets/vardhan2.jpg')}
        alt='pfp'
        className='w-full h-full object-cover' // Adjust the width and height of the image
    />
</div>
                ...
                <div class='w-full max-w-6xl flex flex-col lg:flex-row justify-center gap-10 mt-8'>
                    ...
                    <div class='p-6 w-full lg:w-1/3 rounded-lg shadow-lg flex flex-col items-center border border-yellow-600' data-aos='zoom-in' data-aos-delay='300'>
                    ...
                    <div class='p-6 w-full lg:w-1/3 rounded-lg shadow-lg flex flex-col items-center border border-yellow-600' data-aos='zoom-in' data-aos-delay='500'>
